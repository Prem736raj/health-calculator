    ...
    fun generateReport(
        ...
        fun finishPage(page: PdfDocument.Page) {
            ...
            page.canvas.drawText(
                "${ExportDisclosurePolicy.APP_NAME} — Page ${currentPageNum - 1}",
                PAGE_WIDTH / 2f,
                PAGE_HEIGHT - 20f,
                footerPaint
            )
        ...
        canvas.drawText("Health Metrics Tracker", PAGE_WIDTH / 2f, 100f, logoText)
        ...
        canvas.drawText("Personal Wellness Report", PAGE_WIDTH / 2f, 130f, tagLine)
        ...
        val disclaimerText = ExportDisclosurePolicy.shareFooter()
