...
class ShareImageHelper(@ApplicationContext private val context: Context) {
    ...
    fun generateHealthReportCard(card: HealthReportCard): File {
        ...
        canvas.drawText("${ExportDisclosurePolicy.APP_NAME} · Generated by", width / 2f, yPos + 35f, footerPaint)
        footerPaint.textSize = 16f
        canvas.drawText("${ExportDisclosurePolicy.INFORMATIONAL_LABEL} · ${ExportDisclosurePolicy.DIAGNOSIS_NOTICE}", width / 2f, yPos + 62f, footerPaint)
